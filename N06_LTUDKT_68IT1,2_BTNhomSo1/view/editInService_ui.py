# Form implementation generated from reading ui file 'd:\LTTKUD\DoAn\editInService.ui'
#
...
"")
        ...
        self.widget_2.setGeometry(QtCore.QRect(10, 90, 771, 391))
        ...
        self.spinnerScore = QtWidgets.QDoubleSpinBox(parent=self.widget_7)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.spinnerScore.setFont(font)
        self.spinnerScore.setMaximum(10.0)
        self.spinnerScore.setObjectName("spinnerScore")
        self.horizontalLayout_6.addWidget(self.spinnerScore)
        ...
        self.txtJob = QtWidgets.QLineEdit(parent=self.widget_8)
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        self.txtJob.setFont(font)
        self.txtJob.setObjectName("txtJob")
        self.horizontalLayout_7.addWidget(self.txtJob)
...
"padding: 6px 12px;")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Edit InService Student"))
        self.label_6.setText(_translate("Form", "Scores"))
